...
function PrimeraClientFeatures({ acfData }: { acfData: WashroomCubiclesField }) {
    ...
    <div className={styles.pageWrapper}>
      ...
      <div className={styles.topSection}>
        ...
        <div className={styles.specsWrapper}>
          <h2 className={styles.title}>{acfData.heading || "PRIMERA"}</h2>
...
export default function PrimeraPage() {
  ...
  return (
    <>
      ...
      {acfData ? <PrimeraClientFeatures acfData={acfData} /> : <div>Failed to load content.</div>}
    </>
  );
}