...
function WashroomCubicleModel({ modelPath = "/models/new.glb" }) {
...
function HorizonClientFeatures({ acfData }: { acfData: WashroomCubiclesField }) {
    ...
    <div className={styles.pageWrapper}>
      ...
      <div className={styles.topSection}>
        ...
        <div className={styles.specsWrapper}>
          <h2 className={styles.title}>{acfData.heading || "HORIZON"}</h2>
...
export default function HorizonPage() {
  ...
  return (
    <>
      ...
      {acfData ? <HorizonClientFeatures acfData={acfData} /> : <div>Failed to load content.</div>}
    </>
  );
}