...
import styles from "./UnoPage.module.css";
...
function UnoClientFeatures({ acfData }: { acfData: WashroomCubiclesField }) {
...
export default function UnoPage() {
  ...
  return (
    <>
      ...
      {acfData ? <UnoClientFeatures acfData={acfData} /> : <div>Failed to load content.</div>}
    </>
  );
}